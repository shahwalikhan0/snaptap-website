          ...
          {useCases.map((uc, idx) => (
            ...
            >
              ...
              <div className="w-full lg:w-[45%] shrink-0">
                <div className="rounded-brand overflow-hidden shadow-2xl border border-slate-100 aspect-[4/3] relative">
                  <Image
                    src={uc.image}
                    alt={uc.title}
                    fill
                  ...
                  <span className="absolute top-4 left-4 bg-snaptap-blue-dark text-white text-xs font-bold px-3 py-1 rounded-brand uppercase tracking-wider">
                    {uc.tag}
                  </span>
                </div>
              </div>
              ...
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 bg-snaptap-blue-dark/10 text-snaptap-blue-dark text-xs font-bold px-3 py-1.5 rounded-brand mb-4 uppercase tracking-wider">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Seller side */}
                  <div className="bg-snaptap-blue-dark/5 border border-snaptap-blue-dark/20 rounded-brand p-4">
                    <p className="text-snaptap-blue-dark text-xs font-extrabold uppercase tracking-widest mb-3 flex items-center gap-1.5">
