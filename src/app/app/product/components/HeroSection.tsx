  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 bg-snaptap-blue-dark/20 text-snaptap-blue-dark text-sm font-bold px-4 py-2 rounded-brand mb-6 border border-snaptap-blue-dark/30">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white mb-4 sm:mb-6 leading-tight">
            ...
            <span className="text-snaptap-blue-dark">Immersive AR</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-snaptap-blue-dark text-white font-bold px-8 py-3.5 rounded-brand hover:bg-snaptap-blue-deep transition-all shadow-lg shadow-snaptap-blue-dark/25 hover:shadow-snaptap-blue-dark/40 transform hover:-translate-y-0.5"
            >
              Start as a Seller
            </button>
            <button
              onClick={() => router.push("/app/pricing")}
              className="border border-white/20 text-white font-semibold px-8 py-3.5 rounded-brand hover:bg-white/10 transition-all"
            >
              View Pricing Plans
            </button>
          </div>
      ...
      <div className="relative max-w-4xl mx-auto mt-14 grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={i}
            className="bg-white/5 border border-white/10 rounded-brand px-4 py-5 text-center"
          >
            <p className="text-snaptap-blue-dark text-xl sm:text-2xl font-extrabold mb-1">
              {stat.value}
            </p>
