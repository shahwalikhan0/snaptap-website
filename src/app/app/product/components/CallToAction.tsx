      ...
      <div className="relative max-w-3xl mx-auto text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="bg-snaptap-blue-dark text-white font-bold py-4 px-10 rounded-brand hover:bg-snaptap-blue-deep transition-all shadow-xl shadow-snaptap-blue-dark/20 hover:shadow-snaptap-blue-dark/40 transform hover:-translate-y-1"
          >
            Become a Seller
          </button>
          <button
            onClick={() => router.push("/navigations/contact")}
            className="bg-white/10 border border-white/20 text-white font-bold py-4 px-10 rounded-brand hover:bg-white/15 transition-all"
          >
            Contact Sales
          </button>
        </div>
