    ...
    <section id="introduction" className="mb-16 scroll-mt-28">
      ...
      >
        ...
        <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-6">
          SnapTap is an augmented reality commerce platform that lets businesses
          transform physical products into web-based 3D AR experiences — and
          lets customers view those products life-size in their real environment
          before purchasing.
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { value: "Global Format", label: "Universal 3D format" },
            { value: "QR Code", label: "auto-generated product QR" },
            {
              value: "No App Needed",
              label: "Customers can view AR in browser",
            },
          ].map((stat, i) => (
            <div
              key={i}
