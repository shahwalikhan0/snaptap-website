...
const SignUpPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-white">
      ...
      {/* LEFT SIDE - Branding */}
      <div className="md:w-[40%] bg-gradient-to-br from-[#00A8DE]/10 via-[#00A8DE]/5 to-white flex flex-col items-center justify-center p-8 md:p-12 relative overflow-hidden">
      ...
      {/* RIGHT SIDE - Form */}
      <div className="flex-1 flex items-start justify-center p-6 md:p-12 bg-white overflow-y-auto pt-16 md:pt-24">
        <div className="w-full max-w-[550px]">
          ...
          >
            ...
            >
              <Input prefix={<UserOutlined className="text-slate-300" />} placeholder="johndoe" className="h-11 rounded-xl" />
            </Form.Item>
            ...
            <Form.Item
              ...
              className="sm:col-span-1"
            >
              <Input prefix={<UserOutlined className="text-slate-300" />} placeholder="John Doe" className="h-11 rounded-xl" />
            </Form.Item>
            ...
            >
              <Input prefix={<MailOutlined className="text-slate-300" />} placeholder="john@example.com" className="h-11 rounded-xl" />
            </Form.Item>
            ...
            <Form.Item
              ...
              className="sm:col-span-1"
            >
              <Input prefix={<PhoneOutlined className="text-slate-300" />} placeholder="+92..." className="h-11 rounded-xl" />
            </Form.Item>
            ...
            <Form.Item
              ...
              className="sm:col-span-1"
            >
              <Input.Password prefix={<LockOutlined className="text-slate-300" />} placeholder="••••••••" className="h-11 rounded-xl" />
            </Form.Item>
            ...
            <Form.Item name="category" label={<span className="font-semibold text-slate-700">Category</span>} className="sm:col-span-1 text-slate-300">
              <Select placeholder="Select a business category" className="h-1s1 rounded-xl [&_.ant-select-selector]:!rounded-xl [&_.ant-select-selector]:!h-11 [&_.ant-select-selection-search-input]:!h-11 flex items-center">
            ...
            <Form.Item name="location" label={<span className="font-semibold text-slate-700">Location</span>} className="sm:col-span-1">
              <Input prefix={<EnvironmentOutlined className="text-slate-300" />} placeholder="New York, USA" className="h-11 rounded-xl" />
            </Form.Item>

            <Form.Item name="website_url" label={<span className="font-semibold text-slate-700">Website URL</span>} className="sm:col-span-2">
              <Input prefix={<GlobalOutlined className="text-slate-300" />} placeholder="https://yourbrand.com" className="h-11 rounded-xl" />
            </Form.Item>
              ...
              >
                <div className="py-4">
                  <p className="ant-upload-drag-icon !mb-2">
                    <InboxOutlined className="!text-[#00A8DE]" />
                  </p>
            ...
            <Form.Item className="sm:col-span-2 mt-4 !mb-0">
              <Button
                ...
                loading={loading}
                block
                className="h-12 rounded-xl bg-[#00A8DE] hover:bg-[#007cae] border-none font-bold text-base transition-all active:scale-95"
              >
                Create Account
              </Button>
            </Form.Item>
