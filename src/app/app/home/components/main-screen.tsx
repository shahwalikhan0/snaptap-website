    ...
    <div className="bg-white min-h-screen font-sans text-slate-800">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left z-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-slate-900 mb-6">
              See Before You Buy with <span className="text-[#007cae]">Augmented Reality</span>
            </h1>
      ...
      <div className="py-10 border-y border-slate-100 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {/* Reusing existing Clients component logic but maybe simplified? Use existing component for now. */}
            <Clients /> 
        </div>
      </div>
