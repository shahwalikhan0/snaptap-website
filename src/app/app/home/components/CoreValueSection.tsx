    ...
    <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12">
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <div className="relative rounded-brand overflow-hidden shadow-2xl border border-slate-100">
            <Image
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="flex items-start gap-3">
                <div className="mt-1 w-6 h-6 rounded-brand bg-snaptap-blue-dark/10 flex items-center justify-center shrink-0">
                  <Icon
                    icon="mdi:check"
