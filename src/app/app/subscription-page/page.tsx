    ...
    return (
      <div className="min-h-screen bg-surface-page pt-20 sm:pt-28">
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row min-h-[calc(100vh-96px)] animate-pulse">
          <aside className="w-full lg:w-[320px] lg:border-r border-slate-100 bg-surface-card p-6 space-y-3">
            <div className="h-8 bg-surface-line rounded-brand w-3/4" />
            <div className="h-12 bg-surface-line rounded-brand" />
            <div className="h-12 bg-surface-line rounded-brand" />
            <div className="h-12 bg-surface-line rounded-brand" />
          </aside>
          <main className="flex-1 p-4 sm:p-6 md:p-12">
            <div className="max-w-4xl space-y-6">
              <div className="h-9 bg-slate-100 rounded-brand w-1/2" />
              <div className="h-4 bg-slate-100 rounded-brand w-2/3" />
              <div className="h-48 bg-slate-100 rounded-brand" />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="h-32 bg-slate-100 rounded-brand" />
                <div className="h-32 bg-slate-100 rounded-brand" />
              </div>
            </div>
          </main>
  ...
  return (
    <div className="min-h-screen bg-surface-page pt-20 sm:pt-28">
      ...
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row min-h-[calc(100vh-96px)]">
        ...
        <aside className="w-full lg:w-[320px] lg:border-r border-slate-100 bg-surface-card flex flex-col">
...
// Fades the panel in on tab switch. Previously used `animate-in`/`fade-in`
// Tailwind classes that do nothing without the tailwindcss-animate plugin,
// which isn't installed — the "transition" was never actually running.
