  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <div className="inline-flex items-center gap-2 bg-snaptap-blue-dark/10 text-snaptap-blue-dark text-sm font-semibold px-4 py-2 rounded-brand mb-6">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
          Plans That Grow <span className="text-snaptap-blue-dark">With You</span>
        </h1>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-snaptap-blue-dark text-white font-semibold px-8 py-3.5 rounded-brand hover:bg-snaptap-blue-deep transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        >
          See All Plans
