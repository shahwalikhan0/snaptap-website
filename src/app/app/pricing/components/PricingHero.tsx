  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <div className="inline-flex items-center gap-2 bg-[#007cae]/10 text-[#007cae] text-sm font-semibold px-4 py-2 rounded-[6px] mb-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-[#007cae] text-white font-semibold px-8 py-3.5 rounded-[6px] hover:bg-[#006080] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        >
          See All Plans
