...
export default function InventoryPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-28 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
          <div>
            <div className="flex items-center gap-2 text-[#00A8DE] mb-2">
              <Icon icon="mdi:package-variant-closed" width={24} />
              <span className="font-bold uppercase tracking-wider text-sm">Dashboard</span>
            </div>
            <h1 className="text-4xl font-bold text-slate-900">Your Inventory</h1>
            <p className="text-slate-500 mt-2">Manage and monitor your 3D product catalog</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="relative w-full sm:w-64">
              <Search
                ...
                className="[&_.ant-input]:!rounded-xl [&_.ant-input-group-addon]:!bg-white [&_.ant-input-search-button]:!border-none"
                size="large"
              />
            </div>
            <Segmented
          ...
          <div className="grid gap-4">
            {filteredProducts.map((product) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white rounded-2xl p-4 md:p-6 border border-slate-100 shadow-sm group-hover:shadow-md transition-all flex flex-col md:flex-row items-center gap-6">
                  {/* Product Visual */}
                  <div className="w-24 h-24 rounded-xl bg-slate-50 flex items-center justify-center shrink-0 border border-slate-100 p-2 overflow-hidden">
                    <img
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-4">
                      <span className="text-xl font-black text-[#00A8DE]">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    <Button
                      ...
                      className="h-11 rounded-xl bg-[#00A8DE] hover:bg-[#007cae] border-none font-bold px-8 shadow-sm"
                    >
                      View Details
                    </Button>
                  </div>
